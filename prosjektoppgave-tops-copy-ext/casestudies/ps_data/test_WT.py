...
def load():
    return {
        ...
        'WindTurbine': [
            ...
            ['WT1', 'UIC1',  15,    22,          310619488.,        1836784,        697376449.,    71186519.,       0.66,           0.2,           0.1,         90.0,           0.0,           2.0,              1.225,    120.97,       1.0,       7.53,      10.6,           0.95,           'MPT_Kopt2150.csv', 'Cp_Ct_Cq.IEA15MW.ROSCO.txt']
