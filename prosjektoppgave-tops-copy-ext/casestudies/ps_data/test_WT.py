    ...
    return {
        ...
        'vsc': {
            'UIC_sig_pq': [
                ...
                ['UIC1', 'B2',    20,   22,      1.0,     0.0,      0.0005,    0.1,     0.0,    0.1,        1,          0.1   ] # enable perfect tracking: 1, else 0
            ],
        },
        ...
        'WindTurbine': [
            ...
            ['WT1', 'UIC1',  15,    22,          310619488.,        1836784,        697376449.,    71186519.,       0.66,           0.2,           0.1,         90.0,           0.0,           2.0,              1.225,    120.97,       1.0,       7.53,      10.6,           1,   'MPT_Kopt2150.csv', 'Cp_Ct_Cq.IEA15MW.ROSCO.txt']
