    ...
    return {
        ...
        'generators': {
            'GEN': [
                ...
                ['IB',      'B1',    1e6,    22,       0,      1,      1e5,      0,     1.05,   0.66,    0.328,      0.66,       1e-5,      1e-5,         1e5,      10000,          1e5,        1e5],
            ],
        },
        ...
        'WindTurbine': [
            ...
            ['WT1', 'UIC1',  15,    22,    3.50803121174E+08,      1.836784E+06,       1,           1,      6.97376449E+08, 7.1186519E+07,    60*3.14/180,   13*3.14/180,   1.225,  120.97,     1.5,       7.57,               10.6]
